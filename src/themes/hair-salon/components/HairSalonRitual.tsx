...
export function HairSalonRitual() {
  ...
  return (
    <section className="py-32 bg-[#1A1A1A] px-8 relative overflow-hidden text-[#FDFBF7]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        ...
        <div className="w-full lg:w-1/2 h-[500px] lg:h-[700px] relative rounded-t-full overflow-hidden border border-[#FDFBF7]/10 bg-[#1A1A1A]">
