...
export function HairSalonServices() {
  ...
  return (
    <section className="py-32 bg-[#1A1A1A] text-[#FDFBF7] px-8 relative">
          ...
          {services.map((srv, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-8 w-full md:w-auto justify-between md:justify-end">
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-[#FDFBF7] group-hover:text-[#1A1A1A] transition-colors">
