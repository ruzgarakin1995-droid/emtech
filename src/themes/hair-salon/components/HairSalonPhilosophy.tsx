    ...
    <section className="py-32 bg-[#FDFBF7] px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-20 items-center">
        ...
        <div className="w-full md:w-1/2">
          ...
          >
            <span className="text-[10px] font-sans tracking-[0.3em] uppercase text-[#1A1A1A]/50">Felsefemiz</span>
          ...
          <motion.h2 
            ...
            className="text-4xl md:text-6xl font-serif text-[#1A1A1A] leading-tight mb-10"
          >
          ...
          <motion.div 
            ...
            className="space-y-6 font-sans font-light text-[#1A1A1A]/70 leading-relaxed text-lg max-w-lg"
          >
            <p>
          ...
          <motion.div 
            ...
            className="mt-16 pt-8 border-t border-[#1A1A1A]/10 grid grid-cols-2 gap-8"
          >
            <div>
              <span className="block text-4xl font-serif text-[#1A1A1A] mb-2">15+</span>
              <span className="text-[10px] font-sans tracking-widest uppercase text-[#1A1A1A]/50">Yıllık Tecrübe</span>
            </div>
            <div>
              <span className="block text-4xl font-serif text-[#1A1A1A] mb-2">100%</span>
              <span className="text-[10px] font-sans tracking-widest uppercase text-[#1A1A1A]/50">Vegan Ürünler</span>
            </div>
          </motion.div>
        </div>
