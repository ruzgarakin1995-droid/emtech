...
export function HairSalonCallToAction() {
  return (
    <section className="relative py-32 bg-[#1A1A1A] text-[#FDFBF7] overflow-hidden border-t border-[#FDFBF7]/10">
      ...
      <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
        ...
        <motion.button
          ...
          className="group relative px-12 py-5 overflow-hidden border border-[#C4A484] text-[#C4A484] bg-transparent hover:text-[#1A1A1A] transition-colors duration-500 rounded-full"
        >
