      ...
      >
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
          ...
          <button 
            ...
            className={`md:hidden relative z-[60] p-2 transition-colors duration-500 ${isMobileMenuOpen ? 'text-[#FDFBF7]' : 'text-[#1A1A1A]'}`}
          >
          ...
          <nav className="hidden md:flex gap-10 items-center flex-1">
            <Link 
              ...
              className="text-xs font-sans tracking-[0.1em] uppercase text-[#1A1A1A]/70 hover:text-[#C4A484] transition-colors relative group"
            >
              Hakkımızda
          ...
          <Link href="/test-hair-salon" className="group flex flex-col items-center justify-center relative z-[60] flex-1 text-center">
            <span className={`text-3xl font-serif tracking-widest transition-colors duration-500 ${isMobileMenuOpen ? 'text-[#FDFBF7]' : 'text-[#1A1A1A]'}`}>
              ÉCLAT
            </span>
          ...
          <nav className="hidden md:flex gap-10 items-center justify-end flex-1">
            ...
            <button 
              ...
              className="ml-4 text-xs font-sans tracking-[0.1em] uppercase text-[#FDFBF7] bg-[#1A1A1A] border border-[#1A1A1A] px-6 py-2.5 hover:bg-transparent hover:text-[#1A1A1A] transition-all duration-500"
            >
              Randevu
            </button>
          </nav>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-[#1A1A1A] flex flex-col justify-center items-center px-6"
          >
            ...
            <motion.button 
              ...
              className="text-[11px] font-sans tracking-[0.2em] uppercase text-[#1A1A1A] bg-[#C4A484] px-10 py-4 hover:bg-[#FDFBF7] transition-colors duration-500"
            >
              Randevu Oluştur
            </motion.button>
          </motion.div>
