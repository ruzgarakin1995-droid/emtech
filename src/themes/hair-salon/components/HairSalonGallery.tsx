      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          >
            ...
            <span className="text-[10px] font-sans tracking-[0.3em] uppercase text-[#1A1A1A]/50">Portfolyo</span>
            <div className="w-8 h-[1px] bg-[#1A1A1A]/20"></div>
          </motion.div>
          <motion.h2 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <motion.div style={{ y: y1 }} className="flex flex-col gap-8 md:gap-16">
            ...
            <div className="bg-[#1A1A1A] text-[#FDFBF7] p-12 flex flex-col justify-center items-center text-center aspect-square">
          ...
          <motion.div style={{ y: y2 }} className="flex flex-col gap-8 md:gap-16">
            <div className="bg-[#C4A484]/10 p-12 aspect-square flex flex-col justify-center text-center relative">
              ...
              <h3 className="text-2xl font-serif text-[#1A1A1A] mb-4">Mükemmel Doku</h3>
              <p className="font-sans font-light text-[#1A1A1A]/70 text-sm">Doğal yansımalar ve pürüzsüz bitişler için dünyaca ünlü teknikler kullanıyoruz.</p>
            </div>
