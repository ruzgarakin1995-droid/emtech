  ...
  return (
    <div className="font-sans antialiased text-[#4A403A] bg-[#FDFBF7] selection:bg-[#C19A6B] selection:text-white">
      ...
      */}
      ...
      {/* Footer Area */}
      <footer className="w-full bg-[#1A1614] text-white/50 py-12 text-center text-xs tracking-widest uppercase">
        <p>Â© {new Date().getFullYear()} Luxury Events & Weddings. Tüm Hakları Saklıdır.</p>
      </footer>
    </div>
  );
}
