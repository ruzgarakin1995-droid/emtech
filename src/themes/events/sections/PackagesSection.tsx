      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          {packages.map((pkg, idx) => (
            <div key={idx} className={`p-8 border ${pkg.featured ? 'border-[#C19A6B] bg-[#C19A6B]/10 py-12' : 'border-white/10 bg-white/5'} backdrop-blur-sm text-center transition-transform hover:-translate-y-2 duration-500`}>
