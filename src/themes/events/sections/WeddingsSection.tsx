...
const WeddingsSection = () => {
  return (
    <section className="w-full bg-[#2A2421] text-white overflow-hidden">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 min-h-[500px] lg:min-h-screen relative">
          <img src="https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=80&w=2069&auto=format&fit=crop" alt="Luxury Wedding" className="absolute inset-0 w-full h-full object-cover" />
        </div>
      </div>
    </section>
  );
