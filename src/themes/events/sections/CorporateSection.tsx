    ...
    <section className="w-full bg-[#FDFBF7] text-[#4A403A] overflow-hidden">
      <div className="flex flex-col-reverse lg:flex-row">
        <div className="w-full lg:w-1/2 min-h-[500px] lg:min-h-screen relative">
          <img src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?q=80&w=2098&auto=format&fit=crop" alt="Corporate Event" className="absolute inset-0 w-full h-full object-cover grayscale opacity-80" />
        </div>
