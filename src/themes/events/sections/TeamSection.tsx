...
const TeamSection = () => {
  const team = [
    { name: "Elif Karaca", role: "Kurucu & Kreatif Direktör", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1976&auto=format&fit=crop" },
    { name: "Mert Yılmaz", role: "Etkinlik Prodüktörü", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=1974&auto=format&fit=crop" },
    { name: "Zeynep Aslan", role: "Floral Tasarım Şefi", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=1961&auto=format&fit=crop" }
  ];
