...
export function AestheticServices() {
  ...
  return (
    <section className="py-32 bg-[#FDFCF9] text-[#1C1C1C] px-6 lg:px-8 border-y border-[#1C1C1C]/10">
            ...
            return (
              <div key={section.num} className="border-b border-[#1C1C1C]/20">
                ...
                <button
                  ...
                  className="w-full py-10 md:py-14 flex items-center justify-between group text-left"
                >
                  <div className="flex items-baseline gap-6 md:gap-12">
                    <span className="text-sm md:text-lg font-sans text-[#C4A79A] tracking-widest">{section.num}</span>
                    <h3 className={`text-3xl md:text-5xl lg:text-6xl font-serif transition-colors duration-500 ${isExpanded ? 'text-[#1C1C1C]' : 'text-[#1C1C1C]/40 group-hover:text-[#1C1C1C]'}`}>
                      {section.category}
                    </h3>
                  </div>
                ...
                <AnimatePresence>
                  {isExpanded && (
                    ...
                    >
                      <div className="pb-14 pt-4 pl-12 md:pl-24">
                        <p className="font-sans font-light text-[#1C1C1C]/60 max-w-2xl text-lg mb-12">
                          {section.desc}
                        </p>
