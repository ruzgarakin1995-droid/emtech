...
export function AestheticFooter() {
  return (
    <footer className="bg-[#1C1C1C] text-[#FDFCF9] pt-24 pb-10 border-t-4 border-[#C4A79A]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="md:col-span-4">
            <h2 className="text-3xl font-serif tracking-[0.15em] mb-1 text-[#FDFCF9]">LILA</h2>
            <p className="text-[8px] font-sans tracking-[0.4em] uppercase text-[#C4A79A] mb-8">Aesthetic Clinic</p>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 font-sans font-light text-sm text-[#FDFCF9]/80">
              <li className="flex items-start gap-3">
                ...
                <span>Lila Plaza, Medikal Kat<br/>Şişli, İstanbul</span>
              </li>
              <li className="flex items-center gap-3 pt-2">
                ...
                <a href="tel:+902125555555" className="hover:text-[#C4A79A] transition-colors">+90 (212) 555 55 55</a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-[#FDFCF9]/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-sans tracking-widest uppercase text-[#FDFCF9]/40">
          <p>&copy; {new Date().getFullYear()} Lila Aesthetic Clinic. Tüm Hakları Saklıdır.</p>
