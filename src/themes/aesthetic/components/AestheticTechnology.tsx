    ...
    <section className="py-32 bg-[#FDFCF9] px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="w-full lg:w-1/2 lg:pl-12">
          ...
          >
            <p>
              Lila Aesthetic Clinic'te kullandığımız her cihaz ve ürün, uluslararası sağlık otoriteleri tarafından onaylanmış, güvenlik ve etkinlik testlerinden geçmiş markalardır.
            </p>
            <p>
