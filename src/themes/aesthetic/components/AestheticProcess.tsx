...
export function AestheticProcess() {
  ...
  return (
    <section className="py-32 bg-[#FDFCF9] px-6 lg:px-8 overflow-hidden border-t border-[#1C1C1C]/10">
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <p className="font-sans font-medium text-[10px] tracking-widest uppercase text-[#FDFCF9] mb-2">LILA Diagnostik</p>
