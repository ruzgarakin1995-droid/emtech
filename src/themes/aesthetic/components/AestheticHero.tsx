...
export function AestheticHero() {
  return (
    <section className="relative h-screen min-h-[850px] flex items-center bg-[#FDFCF9] overflow-hidden">
      
      {/* Background/Layout Split */}
      <div className="absolute inset-0 flex flex-col md:flex-row z-0">
        <div className="w-full md:w-[45%] h-full bg-[#FDFCF9] relative">
        ...
        <div className="w-full md:w-[55%] h-full relative">
          ...
          <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[#FDFCF9] to-transparent"></div>
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl lg:text-[80px] font-serif text-[#1C1C1C] leading-[1.05] tracking-tight mb-8"
          >
            Güzelliğe <br/>
