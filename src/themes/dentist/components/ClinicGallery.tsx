...
export function ClinicGallery() {
  ...
  return (
    <section id="klinik" ref={containerRef} className="py-32 bg-[#1A1A1A] text-[#FAFAFA] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ y: y1 }} className="flex flex-col gap-8">
            <div className="aspect-[4/5] overflow-hidden bg-[#FAFAFA]/5">
              <img 
            ...
            <div className="aspect-[16/9] overflow-hidden bg-[#FAFAFA]/5">
              <img 
