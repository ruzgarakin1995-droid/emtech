              ...
              {step === 4 && (
                ...
                >
                  ...
                  <p className="font-sans font-light text-[#1A1A1A]/70 leading-relaxed text-lg max-w-lg mx-auto mb-16">
                    {selectedDate} günü saat {selectedTime} için {selectedService} randevu talebiniz başarıyla alındı. VIP danışmanımız en kısa sürede sizinle iletişime geçerek detayları onaylayacaktır.
                  </p>
