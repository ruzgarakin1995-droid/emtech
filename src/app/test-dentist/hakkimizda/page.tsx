        ...
        <div className="flex flex-col md:flex-row gap-16 md:gap-24 mb-32 items-center">
          ...
          >
            ...
            <p className="font-sans font-light text-[#1A1A1A]/70 leading-relaxed mb-6">
              Lumina Dental, sıradan bir diş kliniği olmanın ötesinde, kişinin kendi potansiyelini keşfettiği bir sanat stüdyosudur. Biz, diş hekimliğini bir tıp dalından ziyade, bireyin ruhunu yüzüne yansıtan bir heykeltıraşlık süreci olarak görüyoruz.
            </p>
            <p className="font-sans font-light text-[#1A1A1A]/70 leading-relaxed">
              Kullandığımız teknolojiler sadece birer araç, asıl olan o aracı yönlendiren estetik vizyondur.
            </p>
          </motion.div>
