        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full md:w-1/2">
            ...
            >
              ...
              <span className="text-[10px] font-sans font-medium tracking-[0.3em] uppercase text-[#1C1C1C]/50">LILA İletişim</span>
            </motion.div>
            ...
            <div className="space-y-10">
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
                ...
                <p className="font-serif text-2xl text-[#1C1C1C]">Nişantaşı, Valikonağı Cd.<br/>No: 45, Şişli / İstanbul</p>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
                ...
                <p className="font-serif text-2xl text-[#1C1C1C] hover:text-[#C4A79A] transition-colors cursor-pointer">+90 (555) 123 45 67</p>
              </motion.div>
