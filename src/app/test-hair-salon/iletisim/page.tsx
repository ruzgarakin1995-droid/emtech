...
export default function ContactPage() {
  return (
    <main className="bg-[#FDFBF7] min-h-screen text-[#1A1A1A] selection:bg-[#C4A484] selection:text-[#1A1A1A]">
      <HairSalonHeader />
      
      {/* Mini Hero */}
      <section className="pt-48 pb-20 px-8 bg-[#1A1A1A] text-[#FDFBF7] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          <div>
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-[10px] font-sans tracking-[0.2em] uppercase text-[#1A1A1A]/50 mb-2">Adres</h3>
                <p className="font-serif text-2xl text-[#1A1A1A]">Valikonağı Cd. No: 45<br/>Nişantaşı, İstanbul</p>
              </div>
              <div>
                <h3 className="text-[10px] font-sans tracking-[0.2em] uppercase text-[#1A1A1A]/50 mb-2">Telefon</h3>
                <p className="font-serif text-2xl text-[#1A1A1A]">+90 (555) 123 45 67</p>
              </div>
              <div>
                <h3 className="text-[10px] font-sans tracking-[0.2em] uppercase text-[#1A1A1A]/50 mb-2">Email</h3>
                <p className="font-serif text-2xl text-[#1A1A1A]">hello@eclathair.com</p>
              </div>
            </div>
          </div>

          {/* Form */}
          <div className="bg-[#1A1A1A] text-[#FDFBF7] p-12">
            ...
            <form className="space-y-8">
              ...
              <button 
                type="button"
                className="w-full bg-[#C4A484] text-[#1A1A1A] py-5 font-sans font-semibold tracking-[0.2em] uppercase text-[10px] hover:bg-[#FDFBF7] transition-colors duration-500"
              >
                Gönder
              </button>
            </form>
